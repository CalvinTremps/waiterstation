  ...
  return (
    <aside className="w-56 shrink-0 bg-gray-900 min-h-screen flex flex-col">
      ...
      <div className="px-5 py-5 flex items-center gap-2.5">
        ...
        <div>
          <p className="text-white font-bold text-sm leading-tight">Waiterstation</p>
      ...
      <div className="px-3 py-4">
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-500 hover:bg-gray-800 hover:text-white transition"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
