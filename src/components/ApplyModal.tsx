      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-y-auto max-h-[90vh]">
        ...
        {submitted ? (
          <div className="px-6 py-10 text-center">
            ...
            <button
              onClick={onClose}
              className="mt-6 bg-emerald-600 text-white text-sm font-semibold px-6 py-2.5 rounded-full hover:bg-emerald-700 transition"
            >
              Done
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 placeholder:text-gray-400"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 placeholder:text-gray-400 resize-none"
              />
            </div>
