...
/**
 * Shared professional line-icon set (Heroicons-style outline, 24×24).
 * Replaces decorative emoji across the app. Use <Icon name="..." />.
 * Role categories have dedicated icons so job listings render consistent,
 * professional glyphs instead of emoji.
 */

const PATHS: Record<string, ReactNode> = {
  // ── Roles ──
  waiter: <path strokeLinecap="round" strokeLinejoin="round" d="M5 12a7 7 0 0114 0M3 12h18M12 5V3" />,
  chef: <path strokeLinecap="round" strokeLinejoin="round" d="M7 21h10m-9-4v4m8-4v4M6 17a3 3 0 01-1-5.83A3.5 3.5 0 0112 6a3.5 3.5 0 017 1.17A3 3 0 0118 17H6z" />,
  kitchen: <path strokeLinecap="round" strokeLinejoin="round" d="M4 20l7-7m0 0l5-5a2 2 0 10-3-3l-5 5m3 3l-3-3" />,
  housekeeping: <path strokeLinecap="round" strokeLinejoin="round" d="M3 18V8m0 6h18m0 4v-6a2 2 0 00-2-2h-7v4M3 11h8M6.5 11a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />,
  front_desk: <path strokeLinecap="round" strokeLinejoin="round" d="M4 17h16M12 17v3m-7-3a7 7 0 0114 0M12 6V4m0 2a5 5 0 015 5" />,
  bartender: <path strokeLinecap="round" strokeLinejoin="round" d="M5 4h14l-7 8-7-8zm7 8v6m-3 0h6" />,
  barista: <path strokeLinecap="round" strokeLinejoin="round" d="M4 8h13v4a5 5 0 01-5 5H9a5 5 0 01-5-5V8zm13 1h2a2 2 0 010 4h-2M7 3v2m4-2v2" />,
  host: <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />,
  manager: <path strokeLinecap="round" strokeLinejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />,
  other: <path strokeLinecap="round" strokeLinejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118L2.98 10.1c-.783-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />,
  ...
  tag: <path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5a1.99 1.99 0 011.414.586l7 7a2 2 0 010 2.828l-5 5a2 2 0 01-2.828 0l-7-7A1.99 1.99 0 013 12V7a4 4 0 014-4z" />,
  ...
  lightbulb: <path strokeLinecap="round" strokeLinejoin="round" d="M9.663 17h4.673M12 3a6 6 0 00-3.075 11.142c.426.25.82.654 1.018 1.118L10.5 17h3l.557-1.74c.198-.464.592-.868 1.018-1.118A6 6 0 0012 3z" />,
  target: <><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 15a3 3 0 100-6 3 3 0 000 6z" /></>,
  ...
  book: <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.247m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.247" />,
  ...
  'id-card': <path strokeLinecap="round" strokeLinejoin="round" d="M3 7a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7zm4 3a1.5 1.5 0 103 0 1.5 1.5 0 00-3 0zm6 0h4m-4 4h4M5.5 15.5a2.5 2.5 0 015 0" />,
  health: <path strokeLinecap="round" strokeLinejoin="round" d="M5 7h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V9a2 2 0 012-2zm7 3v6m3-3H9" />,
  ...
  flame: <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.657 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z" />,
  ...
  share: <path strokeLinecap="round" strokeLinejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m9.632 4.032a3 3 0 10-2.684 0M9 12a3 3 0 11-2.684-1.658" />,
  handshake: <path strokeLinecap="round" strokeLinejoin="round" d="M7 11l3-3 4 4 2-2 3 3m-9-2l-2 2a2 2 0 102.828 2.828L11 13M3 7l4-4 3 3M21 7l-4-4-3 3" />,
}
