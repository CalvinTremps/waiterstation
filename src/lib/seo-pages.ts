...
export const SEO_ROLES: SeoRole[] = [
  ...
  { slug: 'cleaner', label: 'Cleaner', roleCategory: 'housekeeping',
    intro: 'Browse cleaner and housekeeping jobs' },
  ...
  { slug: 'general-worker', label: 'General Worker',
    intro: 'Browse entry-level general worker and hospitality assistant jobs' },
  // ── Broad head terms ──
