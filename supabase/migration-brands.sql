...
-- ─── RLS: service-role only (admin writes via service role) ───────────────────
...
INSERT INTO brands (name, industry, size, location, description, website, logo_url) VALUES
  ...
  ('Steers / Burger Perfecta','Fast Food',         '1 000+ employees', 'Johannesburg (HQ) · Nationwide',  'South Africa''s leading grill-burger fast food chain under Famous Brands, with 500+ locations nationwide.', 'steers.co.za',     'https://logo.clearbit.com/steers.co.za'),
